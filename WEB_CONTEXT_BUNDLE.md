...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-1217-questions-in-geometric-group-theory-q-e3a3de9a",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-1217-d56eb27825bc",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-1217"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Does every closed 3-manifold M which fibers over S1 with fiber of genus ≥2 have a finite cover ˜ M with b1( ˜ M) > 1?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 12.17",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "5d83fcfdf612783c37813af94962aacbe22c7ce21e5043a0c9ab7305b64226ec"
}
```
